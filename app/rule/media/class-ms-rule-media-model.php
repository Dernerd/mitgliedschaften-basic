...
class MS_Rule_Media_Model extends MS_Rule {
	...
	public static function get_protection_types() {
		...
		$example1 	= '<br /><small>' . __( 'Beispiel:', 'membership2' ) . ' ' . $example1 . '</small>';
		$example2 	= '<br /><small>' . __( 'Beispiel:', 'membership2' ) . ' ' . $example2 . '</small>';
		$example3 	= '<br /><small>' . __( 'Beispiel:', 'membership2' ) . ' ' . $example3 . '</small>';

		$protection_types = array(
			self::PROTECTION_TYPE_BASIC 	=> __( 'Basisschutz (Standard)', 'membership2' ) . $example1,
			self::PROTECTION_TYPE_COMPLETE 	=> __( 'Vollständiger Schutz', 'membership2' ) . $example2,
			self::PROTECTION_TYPE_HYBRID 	=> __( 'Hybridschutz', 'membership2' ) . $example3,
		);
